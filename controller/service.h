...
//    vector<Action*> undoAdminStack;
//    vector<Action*> redoAdminStack;
    std::vector<std::unique_ptr<Action>> undoAdminStack;        // OR use a std::stack
    std::vector<std::unique_ptr<Action>> redoAdminStack;
